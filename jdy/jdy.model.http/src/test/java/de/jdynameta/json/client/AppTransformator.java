...
class AppTransformator implements ObjectTransformator<GenericValueObjectImpl, GenericValueObjectImpl>
{
	/**
	 * 
	 */
	...
	@Override
	public TypedValueObject getValueObjectFor(ClassInfo aClassinfo,	GenericValueObjectImpl aObjectToTransform) 
	{
		return aObjectToTransform;
	}
