 ...
 *
 */
public class ModelComboboxField extends AttributeCombobox<ModelComboboxField.DomainValueComboElem>
	implements AttrInfoComponent
{
	private PrimitiveAttributeInfo textAttributeInfo;
	
	public ModelComboboxField(ObjectListModel<DomainValueComboElem>  aObjectColl, PrimitiveAttributeInfo aTextAttributeInfo) 
	{
		super( aObjectColl);
