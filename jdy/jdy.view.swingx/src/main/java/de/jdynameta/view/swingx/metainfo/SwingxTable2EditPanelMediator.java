...
import de.jdynameta.metainfoview.metainfo.ValueModelFilterTablePanel;
 ...
 * 
 */
public class SwingxTable2EditPanelMediator<TEditObj extends ApplicationObj>
		extends PanelMediator
{
	private SwingxFilterTablePanel<TEditObj> objectTable;
	...
	private final boolean persistentListenerIsUsed = true;
	 ...
	 * 
	 */
	public SwingxTable2EditPanelMediator(ClassInfo aClassInfo,
	...
	protected SwingxFilterTablePanel<TEditObj> getObjectTableLazy() throws JdyPersistentException
	{
		if( this.objectTable == null ) {
			...
			this.objectTable.setEditObjectHandler( createEditSelectedOrderHandler());
	...
	protected SwingxFilterTablePanel<TEditObj> getObjectTable() 
	{
		return objectTable;
	}
	...
	protected SwingxFilterTablePanel<TEditObj> createObjectTable() throws JdyPersistentException
	{
		return new SwingxFilterTablePanel<TEditObj>(this.classInfo, this.applicationMngr, this.panelManager, persistentListenerIsUsed);
	...
	private SwingxTablePanel.EditObjectHandler<TEditObj> createEditSelectedOrderHandler()
	{
		return new SwingxTablePanel.EditObjectHandler<TEditObj>()
		{
	...
	protected ValueModeSavePanel<TEditObj> createObjectEditPanel() throws JdyPersistentException
	{
		...
		if( this.layoutStrategy == null) {
			layoutStrategy =  new GroupedLayoutStrategy(panelManager.res());
									
		}

		if( this.createComponentStrategy == null) {
			creationStrategy = new SwingxCreationStrategy<TEditObj>(panelManager, applicationMngr);
		}
