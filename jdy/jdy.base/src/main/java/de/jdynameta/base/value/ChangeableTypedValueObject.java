...
public interface ChangeableTypedValueObject extends TypedValueObject, ChangeableValueObject
{

    public ObjectList<? extends TypedValueObject> getValues(String anAssocName);

    public Object getValue(String anExternlAttrName);
