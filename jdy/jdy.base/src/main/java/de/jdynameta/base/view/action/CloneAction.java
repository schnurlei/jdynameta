...
public interface CloneAction<TViewObj extends ViewObject> extends ViewAction<TViewObj>
{
	public TViewObj cloneObject(TViewObj editedObject)throws ObjectCreationException;
