...
public class AbstractSdiFrame extends JFrame
{
	...
	private final ArrayList<AbstractSdiFrame> dependentFrameColl;
	
	/**
	 * @throws java.awt.HeadlessException
	 */
	public AbstractSdiFrame(PanelManager aPanelManager) throws HeadlessException
	{
		super();
		this.panelManager = aPanelManager;
		this.dependentFrameColl = new ArrayList<AbstractSdiFrame>();
	 ...
	 * @param aChildFrame
	 */
	public void addDependentFrame(AbstractSdiFrame aChildFrame)
	{
	...
	{
		return panelManager.getResourceLoader();
	}
	 ...
	 * @throws CloseVetoException throws this exception, when the frame could not be closed, sender is responsible for
	 * 				a proper user notification
	 */
	public void closeAllFrames() throws CloseVetoException
	{
		for (AbstractSdiFrame curFrame : dependentFrameColl) {
	...
	/**
	 * Closes and dispose this Frame. Called by CloseAllFrames to close only the current frame
	 * @throws CloseVetoException throws this exception, when the frame could not be closed, sender is responsible for
	 * 				a proper user notification
	 */
