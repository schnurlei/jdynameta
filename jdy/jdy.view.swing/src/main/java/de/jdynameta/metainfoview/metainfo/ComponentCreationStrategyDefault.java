...
import de.jdynameta.metainfoview.attribute.model.ModelDateTextField;
import de.jdynameta.metainfoview.attribute.model.ModelDoubleTextField;
import de.jdynameta.metainfoview.attribute.model.ModelLongTextField;
...
public class ComponentCreationStrategyDefault<TEditObj extends ApplicationObj> 
	implements ComponentCreationStrategy
{
	...
	public ComponentCreationStrategyDefault(PanelManager aPanelManager, ApplicationManager<TEditObj> anAppManager)
	{
		super();
		...
		throws JdyPersistentException 
	{
		...
		if( domainValues == null || domainValues.size() == 0) {
			...
			return new ModelComboboxField(comboElemColl,aInfo);
		}		
	...
	protected static class JComponentCreatorVisitor  implements PrimitiveTypeVisitor
	{
		...
		{
			this.attrComponent = new ModelLongTextField( attrInfo, Locale.getDefault() );
		}
		...
		{
			this.attrComponent = new ModelDateTextField(attrInfo, Locale.getDefault());
//			this.panelToAdd.add(new JLabel(this.attrInfo.getInternalName()), this.lblConstraints);
//			this.panelToAdd.add(new JFormattedTextField(), this.fieldConstraints);
		}
