...
import de.jdynameta.jdy.model.json.JsonCompactFileReader.GeneratedValueCreator;
import de.jdynameta.jdy.model.json.JsonCompactFileWriter;
...
public class FilterCreatorTest 
{
	...
	public void readCompactfilterExpression() throws JdyPersistentException
	{
		...
		Assert.assertEquals(new Long(100l), operatorExpr.getValue("longVal"));
	...
	{
		InputStream resource = FilterCreatorTest.class.getResourceAsStream("simpleRepo.json");
