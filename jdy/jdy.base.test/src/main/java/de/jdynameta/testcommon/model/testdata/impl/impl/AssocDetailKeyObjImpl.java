...
/**
 * AssocDetailKeyObjImpl
 *
 * @author Copyright &copy;  
 * @author Rainer Schneider
 * @version 
 */
public  class AssocDetailKeyObjImpl extends de.jdynameta.base.value.defaultimpl.ReflectionValueObject

{
	private java.lang.Long simpleIntKey;
	private java.lang.String simpleKeyData1;
	private AssociationMasterObjImpl assocKeyRef;

	/**
	 *Constructor 
	 */
	public AssocDetailKeyObjImpl ()
	{
	 ...
	 * Get the assocKeyRef
	 * @generated
	 * @return get the assocKeyRef
	 */
	public AssociationMasterObjImpl getAssocKeyRef() 
	{
		return assocKeyRef;
	}
	 ...
	 * @param assocKeyRef
	 */
	public void setAssocKeyRef( AssociationMasterObjImpl aAssocKeyRef) 
	{
		assocKeyRef = aAssocKeyRef;
	}
	...
	{
		AssocDetailKeyObjImpl typeObj = (AssocDetailKeyObjImpl) compareObj;
		return typeObj != null 
				&& ( 
					( 
					...
					&& (getAssocKeyRef() != null
					&& typeObj.getAssocKeyRef() != null
					&& typeObj.getAssocKeyRef().equals( typeObj.getAssocKeyRef()) )
					)
					|| ( getSimpleIntKey() == null
					&& typeObj.getSimpleIntKey() == null
					&& getAssocKeyRef() == null
	...
	public int hashCode() 
	{
		return 				 (( simpleIntKey != null) ? simpleIntKey.hashCode() : super.hashCode())
			^
				 (( assocKeyRef != null) ? assocKeyRef.hashCode() : super.hashCode())		;
	}
