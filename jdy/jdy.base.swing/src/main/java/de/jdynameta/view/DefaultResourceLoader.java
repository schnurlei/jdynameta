...
public class DefaultResourceLoader implements JdyResourceLoader
{
	private static Logger logger = Logger.getLogger(DefaultResourceLoader.class.getName());
	 ...
	 */
	public DefaultResourceLoader(IconKeyToPathMapper aIconMapper, Class<? extends Object> aIconLoaderClass, ResourceBundle ... aResourceBundels )
	{
		super();
