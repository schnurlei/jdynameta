...
public interface SaveAction<TViewObj extends ViewObject> extends ViewAction<TViewObj>
{
	/**
	 ...
	 */
	public void saveObject(TViewObj editedObject, ViewCtxt aContext) throws JdyPersistentException;
