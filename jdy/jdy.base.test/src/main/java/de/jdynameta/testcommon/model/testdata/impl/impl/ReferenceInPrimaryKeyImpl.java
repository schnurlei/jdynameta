...
/**
 * ReferenceInPrimaryKeyImpl
 *
 * @author Copyright &copy;  
 * @author Rainer Schneider
 * @version 
 */
public  class ReferenceInPrimaryKeyImpl extends de.jdynameta.base.value.defaultimpl.ReflectionValueObject

{
	 ...
	 *Constructor 
	 */
	public ReferenceInPrimaryKeyImpl ()
	{
	...
	{
		ReferenceInPrimaryKeyImpl typeObj = (ReferenceInPrimaryKeyImpl) compareObj;
		return typeObj != null 
				&& ( 
					( 
