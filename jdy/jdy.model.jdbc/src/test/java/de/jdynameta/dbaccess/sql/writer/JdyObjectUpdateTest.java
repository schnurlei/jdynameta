 ...
 *
 */
public abstract class JdyObjectUpdateTest extends TestCase
{
    public JdyObjectUpdateTest()
    {
        super();
    }
     ...
     */
    public JdyObjectUpdateTest(String name)
    {
        super(name);
    }
     ...
     */
    public void testUpdateAllPrimitiveTypeObj() throws Exception
    {
...
//		valueObjToInsert.setBlobData(new BlobByteArrayHolder(clobValue));
        ...
        Arrays.fill(clobValue, (byte) 's');

        valueObjToInsert.setBooleanData(false);
        valueObjToInsert.setClobData(new String(clobValue));
//		valueObjToInsert.setBlobData(new BlobByteArrayHolder(clobValue));
        valueObjToInsert.setCurrencyData(new BigDecimal(7777.78));
        valueObjToInsert.setDateData(new Date(System.currentTimeMillis()));
        valueObjToInsert.setFloatData(2342.989);
        valueObjToInsert.setLongData(new Long(333333));
        valueObjToInsert.setTextData("Test data updaete ");
        valueObjToInsert.setTimeData(new Timestamp(System.currentTimeMillis()));
        valueObjToInsert.setTimestampData(new Timestamp(System.currentTimeMillis()));
        valueObjToInsert.setVarCharData("Varchar data update");

        writer.updateObjectToDb(valueObjToInsert, testClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateSimpleKeyObj() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        writer.insertObjectInDb(simpleKeyObj, testClassInfo);

        simpleKeyObj.setSimpleKeyData1("Test String updated");
        writer.updateObjectToDb(simpleKeyObj, testClassInfo);
        assertValueIsSet(testClassInfo, (PrimitiveAttributeInfo) testClassInfo.getAttributeInfoForExternalName("SimpleKeyData1Ex"), simpleKeyObj);
    }

    /**
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateCompoundKeyClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        compoundKeyObj.setCompoundKeyData(new Date(System.currentTimeMillis()));
        ...
        writer.updateObjectToDb(compoundKeyObj, testClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateReferencesClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        valueObjWithRefToInsert.setReferenceData("Update  reference data");
        writer.updateObjectToDb(valueObjWithRefToInsert, testClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateReferenceInPrimaryKeyClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        valueObjWithRefToInsert.setReferenceData("Update  reference data");
        writer.updateObjectToDb(valueObjWithRefToInsert, refInPrimKeyClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateReferenceInKeyDeepClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        valueObjDeepRef.setBonusDate(UtilDate.createSqlDate(2006, 5, 25));
        writer.updateObjectToDb(valueObjDeepRef, refDeepClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateReferenceOnSelfKeyClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        compoundObjToInsert2.setSimpleData(UtilDate.createSqlDate(2006, 5, 25));
        writer.updateObjectToDb(compoundObjToInsert2, refOnSelfClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateReferenceTwoOnSameObjClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        refObjToInsert.setSimpleData1("Test simple data 1 updated");
        writer.updateObjectToDb(refObjToInsert, refOnSameClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateAssocMasterClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        writer.updateObjectToDb(assocMasterObj, assocMasterClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateAssocDetailSimpleInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        assocDetailSimpl.setSimpleKeyData1("Test simple ref UPDATED");
        writer.updateObjectToDb(assocDetailSimpl, assocDetailClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateAssocDetailKeyInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        assocDetailKey.setSimpleKeyData1("Test simple uPDATED");
        writer.updateObjectToDb(assocDetailKey, assocDetailClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateAssocDetailNotNullInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        assocDetailNotNull.setSimpleKeyData1("Test simple uPDATED");
        writer.updateObjectToDb(assocDetailNotNull, assocDetailClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateSubclassSimpleKeyObjInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        assocSubclassDetailKey.setSimpleDataSub1("Test sub uPDATED");
        writer.updateObjectToDb(assocSubclassDetailKey, subclassSimpleKeyClassInfo);
     ...
     * @throws SQLException DOCUMENT ME!
     */
    public void testUpdateSubClassReferenceInKeyDeepClassInfo() throws Exception
    {
        ObjectWriter writer = getObjectWriter();
        ...
        assocSubclassDetailKey.setReferenceData("Test referece updated");
        writer.updateObjectToDb(assocSubclassDetailKey, assocDetailClassInfo);
        // value is set in superclass
        assertValueIsSet(new ComplexTestDataMetaInfoRepository().getReferenceInPrimaryKeyWithSubclassClassInfo(), (PrimitiveAttributeInfo) assocDetailClassInfo.getAttributeInfoForExternalName("ReferenceDataEx"), assocSubclassDetailKey);
    }
