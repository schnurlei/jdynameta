...
public interface WorkflowPersistenceHook<TEditedApplicObj extends PersistentValueObject>
{
    public void beforeSave(TEditedApplicObj editedObject) throws WorkflowException;
