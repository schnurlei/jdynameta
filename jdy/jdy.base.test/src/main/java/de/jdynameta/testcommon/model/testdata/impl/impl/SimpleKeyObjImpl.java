 ...
 * @version 
 */
public  class SimpleKeyObjImpl extends de.jdynameta.base.value.defaultimpl.ReflectionValueObject

{
	...
	{
		SimpleKeyObjImpl typeObj = (SimpleKeyObjImpl) compareObj;
		return typeObj != null 
				&& ( 
					( 
