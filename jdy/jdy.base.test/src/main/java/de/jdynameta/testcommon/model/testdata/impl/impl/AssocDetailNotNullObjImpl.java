...
/**
 * AssocDetailNotNullObjImpl
 *
 * @author Copyright &copy;  
 * @author Rainer Schneider
 * @version 
 */
public  class AssocDetailNotNullObjImpl extends de.jdynameta.base.value.defaultimpl.ReflectionValueObject

{
	private java.lang.Long simpleIntKey;
	private java.lang.String simpleKeyData1;
	private AssociationMasterObjImpl assocNotNullRef;

	/**
	 *Constructor 
	 */
	public AssocDetailNotNullObjImpl ()
	{
	...
	/**
	 * Get the assocNotNullRef
	 * @generated
	 * @return get the assocNotNullRef
	 */
	public AssociationMasterObjImpl getAssocNotNullRef() 
	{
		return assocNotNullRef;
	}

	/**
	 * set the assocNotNullRef
	 * @generated
	 * @param assocNotNullRef
	 */
	public void setAssocNotNullRef( AssociationMasterObjImpl aAssocNotNullRef) 
	{
		assocNotNullRef = aAssocNotNullRef;
	}
	...
	{
		AssocDetailNotNullObjImpl typeObj = (AssocDetailNotNullObjImpl) compareObj;
		return typeObj != null 
				&& ( 
					( 
