...
import de.jdynameta.metainfoview.attribute.AttributeDateTextfield;
 ...
 *
 */
public class ModelDateTextField extends AttributeDateTextfield
	implements AttrInfoComponent
{
	private PrimitiveAttributeInfo dateAttributeInfo;
	
	public ModelDateTextField(PrimitiveAttributeInfo aDateAttributeInfo, Locale aLocale) 
	{
		super(aLocale);
