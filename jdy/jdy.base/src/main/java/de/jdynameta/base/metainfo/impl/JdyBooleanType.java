...
public class JdyBooleanType extends JdyPrimitiveType
        implements BooleanType, Serializable
{

    /**
     * Constructor for BooleanType.
     */
    public JdyBooleanType()
    {
        super(Boolean.class);
    }
    ...
    {
        aHandler.handleValue((Boolean) objToHandle, this);
    }
