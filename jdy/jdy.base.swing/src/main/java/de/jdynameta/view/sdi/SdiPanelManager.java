...
import de.jdynameta.view.panel.ExceptionDialog;
 ...
 * @version 
 */
public class SdiPanelManager implements PanelManager 
{
    ...
    public SdiPanelManager(JdyResourceLoader aResourceLoader, File aPropertyHome) 
    {	
	...
	/**
	 * Display the Base Panel in a Frame. Create a new Frame,
	...
	public void displayErrorDialog( JComponent parentComponent, String aMessage, Throwable exception) {
		...
		ExceptionDialog dialog = new ExceptionDialog(parentComponent, aMessage, exception,  resourceLoader);
