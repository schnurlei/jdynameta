...
public class RendererCreationStrategyDefault implements	RendererCreationStrategy 
{
	...
	public TableCellRenderer createRendererFor(AttributeInfo aInfo,	ClassInfoAttrSource attrSource) 
	{
		...
		return new AttributeTableCellRendererWrapper(aInfo, handler.getRenderer());
	}
