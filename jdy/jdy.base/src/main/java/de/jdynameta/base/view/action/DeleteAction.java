...
public interface DeleteAction<TViewObj extends ViewObject> extends ViewAction<TViewObj>
{
	/**
	 ...
	 */
	public void deleteObject(TViewObj objToDel, ViewCtxt aContext) throws JdyPersistentException;
