...
{
    private static final Logger logger = Logger.getLogger(VersionInformation.class.getName());
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            logger.info("Version: " + version.getBuildVersion());
            logger.info("Build: " + version.getBuildVersion());
        } catch (Exception e1)
        {
