...
import de.jdynameta.metainfoview.attribute.AttributeLongTextfield;
 ...
 *
 */
public class ModelLongTextField extends AttributeLongTextfield
	implements AttrInfoComponent
{
	private PrimitiveAttributeInfo longAttributeInfo;
	
	public ModelLongTextField(PrimitiveAttributeInfo aLongAttributeInfo, Locale aLocale) 
	{
