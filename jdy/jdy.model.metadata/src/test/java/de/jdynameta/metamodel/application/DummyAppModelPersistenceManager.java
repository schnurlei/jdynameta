...
final class DummyAppModelPersistenceManager extends BasicPersistenceObjectManagerImpl<ChangeableValueObject, GenericValueObjectImpl> 
{
	private static final long serialVersionUID = 1L;

	public DummyAppModelPersistenceManager(	DbAccessConnection<ChangeableValueObject, GenericValueObjectImpl> aDbConnection) 
	{
		super(aDbConnection);
	}
