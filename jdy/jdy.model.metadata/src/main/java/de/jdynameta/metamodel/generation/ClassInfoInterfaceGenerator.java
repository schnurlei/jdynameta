...
public class ClassInfoInterfaceGenerator extends AbstractClassCodeGenerator
{
    ...
    private final Collection<String> allExtendedInterfaces;

    public ClassInfoInterfaceGenerator(ClassInfo aInfo, ClassNameCreator aClassNameCreator, Collection<String> someExtededInterfaces)
    {
        super();
        this.info = aInfo;
    ...
    public void appendImportDeclarations()
    {
        ...
        for (Iterator<Class> typeIter = referencedTypeSet.iterator(); typeIter.hasNext();)
        {
            Class curType = typeIter.next();
        ...
        {
            ClassInfo curType = typeIter.next();
        ...
        {
            appendLineWithTabs(0, "import java.util.ArrayList;");
        }
    }
    ...
    private void appendAssociationMethods()
    {
        for (AssociationInfo curAssoc : info.getAssociationInfoIterator())
        {
            ...
            appendAssocGetterDeclaration(curAssoc.getNameResource() + "Coll", "de.jdynameta.base.objectlist.ObjectList");
            appendAssocSetDetailMethod(curAssoc.getNameResource() + "Coll", "de.jdynameta.base.objectlist.ObjectList");
